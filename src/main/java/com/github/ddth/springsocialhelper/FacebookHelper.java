...
public class FacebookHelper {
	private final static LoadingCache<String, Facebook> cachedFacebooks;
	static {
		int numProcessors = Runtime.getRuntime().availableProcessors();
		cachedFacebooks = CacheBuilder.newBuilder()
				.concurrencyLevel(numProcessors).maximumSize(1000)
				.expireAfterWrite(3600, TimeUnit.SECONDS)
				.build(new CacheLoader<String, Facebook>() {
					@Override
					public Facebook load(String accessToken) throws Exception {
	...
	public static Facebook getFacebook(final String accessToken) {
		try {
			Facebook facebook = cachedFacebooks.get(accessToken);
			return facebook;
	...
	public static Map<String, Object> getFeedInfo(final String accessToken,
			String feedId) {
	 ...
	 */
	public static String postTextToPage(final String accessToken,
	 ...
	 * @return id of the created feed
	 */
	public static String postLinkToPage(final String accessToken,
	 ...
	 */
	public static String postLinkToPage(final String accessToken,
			String pageId, String url, String caption, String message) {
	 ...
	 */
	public static String postLinkToPage(final String accessToken,
			String pageId, String message, FacebookLink facebookLink) {
		Facebook facebook = getFacebook(accessToken);
		return facebook.pageOperations().post(pageId,
				message != null ? message.trim() : null, facebookLink);
	}
	 ...
	 */
	public static String postPhotoToPage(final String accessToken,
			String pageId, String albumId, String message, File photo) {
		return postPhotoToPage(accessToken, pageId, albumId, message,
				new FileSystemResource(photo));
	}
	 ...
	 */
	public static String postPhotoToPage(final String accessToken,
			String pageId, String albumId, String message, byte[] photo) {
		return postPhotoToPage(accessToken, pageId, albumId, message,
	 ...
	 */
	public static String postPhotoToPage(final String accessToken,
			String pageId, String albumId, String message, InputStream photo) {
		return postPhotoToPage(accessToken, pageId, albumId, message,
	 ...
	 */
	public static String postPhotoToPage(final String accessToken,
			String pageId, String albumId, String message, URL photo) {
		return postPhotoToPage(accessToken, pageId, albumId, message,
				new UrlResource(photo));
	}

	private static String postPhotoToPage(final String accessToken,
			String pageId, String albumId, String message, Resource resource) {
		Facebook facebook = getFacebook(accessToken);
		if (message == null) {
			return facebook.pageOperations().postPhoto(pageId,
					albumId != null ? albumId : pageId, resource);
		} else {
			return facebook.pageOperations().postPhoto(pageId,
					albumId != null ? albumId : pageId, resource,
					message.trim());
